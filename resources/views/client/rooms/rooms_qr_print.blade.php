            ...
            <div class="col-md-8">
                <div class="row text-center">
                    @foreach ($rooms as $room)
                        <div class="w-50 mt-3" style="margin-bottom: 80px;">
                            {{-- <div class="shop-logo" style="height: 45px"> --}}
                            <div class="shop-logo">
                            ...
                            <img src="{{ asset('public/client_uploads/shops/'.$shop_slug.'/rooms/'.$room['qr_code']) }}" width="260">
                            <p class="m-0"><strong>Room No. : {{ $room['room_no'] }}</strong></p>
